...
////////////// ADDED BY MO: wait_for_idel ///////////
// waitOpts: {"idleTimeout":500, "globalTimeout":5000}
// idleTimeout: The timeout in milliseconds between two events to consider the device idle
// globalTimeout: The maximal global timeout in milliseconds in which to wait for an idle state.
commands.mobileWaitForIdle = async function (waitOpts) {
  return await this.proxyCommand('/wda/waitForIdle', 'POST', waitOpts);
};
//END
